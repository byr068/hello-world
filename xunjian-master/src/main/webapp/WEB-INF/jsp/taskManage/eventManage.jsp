                                       ...
                                       <%-- <td style="width: 100px;" class="center">查看操作记录</td>--%>
                                        <td style="width: 60px;" class="center">
                                            <div class='hidden-phone visible-desktop btn-group'>
                                                ...
                                                <%--编辑事件--%>
                                                <c:if test="${QX.edit == 1 }">
                                                    <c:if test="${user.USERNAME != 'admin'}"><a class='btn btn-mini btn-info' title="编辑"  onclick="edit('${var.event_id}');">
                                                        <img src="static/images/edit.png" style="width:14px;height:14px" alt="">
                                                    </a></c:if>
                                                    <c:if test="${user.USERNAME == 'admin'}"><a class='btn btn-mini btn-info' title="您不能编辑"><img src="static/images/edit.png" style="width:18px;height:19px" alt=""></i></a></c:if>
                                                </c:if>
                                                &nbsp;&nbsp;&nbsp;
                                                <c:if test="${QX.edit == 1 }">
