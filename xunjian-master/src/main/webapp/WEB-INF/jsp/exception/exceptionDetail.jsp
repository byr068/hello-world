...
<table id="table_report" class="table table-striped table-bordered table-hover">
    ...
    <c:if test="${result.status==1}"><a class="btn btn-mid btn-success" href="${basePath}sendtask/goSendTask2.do?exceptionId=${result.id}">下发维修任务</a>
                                      <a class="btn btn-mid btn-success" href="${basePath}sendtask/goSendTask1.do?exceptionId=${result.id}">下发临时巡检任务</a>
                                      <a class="btn btn-mid btn-success" href="${basePath}sendtask/goSendTask3.do?exceptionId=${result.id}">忽略异常</a></c:if>
