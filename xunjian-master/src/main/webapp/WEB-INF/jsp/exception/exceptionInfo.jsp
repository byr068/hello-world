                    ...
                    <tr>
                        ...
                        <%--<c:if test="${QX.cha == 1 }">--%>
                            ...
                            <c:if test="${QX.edit == 1 }">
                                ...
                                <td style="vertical-align:top;"><a class="btn btn-mini btn-light" onclick="toExcel();" title="导出到EXCEL"><i id="nav-search-iconq" class="icon-download-alt"></i></a></td>
                            </c:if>
                        <%--</c:if>--%>
                    </tr>
                </table>
...
<script type="text/javascript">
    ...
    //导出excel
    function toExcel(){
        window.location.href='<%=basePath%>exception/excel.do';
    }
