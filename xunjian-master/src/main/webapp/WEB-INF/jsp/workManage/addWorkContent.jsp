...
<body>
<form action="workset/addWorkContent.do" id="Form"   method="post">
    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                ...
                <td><input style="width:90%;" type="text" name="content_name" id="content_name" value="${pd.content_name}" maxlength="200"  title=""/></td>
                <td style="width:110px;text-align: right;padding-top: 13px;">工作内容属性:</td>
                <td>
                    <select name="content_type" id="content_type" value="${pd.content_type}"class="form-control">
            ...
            <tr>
                ...
                <td>
                    <select name="is_backNum" id="is_backNum" class="form-control" value="${pd.is_backNum}" >
                ...
                <td>
                    <input style="width:90%;" type="text" name="backNum_upLimit" id="backNum_upLimit" value="${pd.backNum_upLimit}" placeholder="数值上限" maxlength="100"  title=""/>
                    <input style="width:90%;" type="text" name="backNum_downLimit" id="backNum_downLimit" value="${pd.backNum_downLimit}" placeholder="数值下限"  maxlength="100"  title=""/>
                </td>
                ...
                <td>
                    ...
                    <select name="numFontColor" id="numFontColor" class="form-control"  value="${pd.numFontColor}">
                        <option value="#000000">黑色</option>
                        <option value="#FF0000">红色</option>
                        <option value="#0000FF">蓝色</option>
                    </select>
                    <select name="numFontSize" id="numFontSize" class="form-control"  value="${pd.numFontSize}">
            ...
            <tr>
                ...
                <td>
                    <select name="is_takePhoto" id="is_takePhoto" class="form-control" value="${pd.is_takePhoto}" >
                        <option value="1">是</option>
                        <option value="0">否</option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td><input style="width:90%;" type="text" name="notice" id="notice" value="${pd.notice}" maxlength="200"  title=""/></td>
                ...
                <td>
                    ...
                    <select name="noticeFontColor" id="noticeFontColor" value="${pd.noticeFontColor}" class="form-control">
                        <option value="#000000">黑色</option>
                        <option value="#FF0000">红色</option>
                        <option value="#0000FF">蓝色</option>
                    </select>
                    <select name="noticeFontSize" id="noticeFontSize" value="${pd.noticeFontSize}" class="form-control">
                        <option value="18">18</option>
                        <option value="20">20</option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="exceptionLevel" id="nexceptionLevel" value="${pd.nexceptionLevel}" class="form-control">
                ...
                <td><input style="width:90%;" type="text" name="exception" id="exception" value="${pd.exception}" maxlength="200"  title=""/></td>
                <td style="width:110px;text-align: right;padding-top: 13px;">异常标准大小、颜色:</td>
                <td>
                    <select name="exceptionFontColor" id="exceptionFontColor"value="${pd.exceptionFontColor}" class="form-control">
                        <option value="#000000">黑色</option>
                        <option value="#FF0000">红色</option>
                        <option value="#0000FF">蓝色</option>
                    </select>
                    <select name="exceptionFontSize" id="exceptionFontSize" value="${pd.exceptionFontSize}" class="form-control">
                        <option value="18">18</option>
                        <option value="20">20</option>
                    </select>
                </td>
