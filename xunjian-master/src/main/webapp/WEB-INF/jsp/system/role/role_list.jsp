                            ...
                            <c:if test="${QX.cha == 1 }">
                                <c:forEach items="${roleList_z}" var="var" varStatus="vs">
                                    ...
                                    <c:forEach items="${kefuqxlist}" var="varK" varStatus="vsK">
                                        ...
                                        <c:if test="${var.QX_ID == varK.GL_ID }">       <%--表示是他的所属下级--%>
                                    ...
                                    <tr>
                                        ...
                                        <td id="ROLE_NAMETd${var.ROLE_ID }">${var.ROLE_NAME }</td>     <%--角色--%>
                                        <c:if test="${QX.edit == 1 }">
                                            ...
                                            <td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','add_qx');"        <%--增--%>
                                                                       class="btn btn-warning btn-mini"
                                                                       title="分配新增权限"><i
                                                    class="icon-wrench icon-2x icon-only"></i></a></td>
                                            <td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','del_qx');"        <%--删--%>
                                                                       class="btn btn-warning btn-mini"
                                                                       title="分配删除权限"><i
                                                    class="icon-wrench icon-2x icon-only"></i></a></td>
                                            <td style="width:30px;"><a
                                                    onclick="roleButton('${var.ROLE_ID }','edit_qx');"                <%--改--%>
                                                    class="btn btn-warning btn-mini" title="分配修改权限"><i
                                                    class="icon-wrench icon-2x icon-only"></i></a></td>
                                            <td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','cha_qx');"     <%--查--%>
                                                                       class="btn btn-warning btn-mini"
                                                                       title="分配查看权限"><i
                                                    class="icon-wrench icon-2x icon-only"></i></a></td>
                                        </c:if>
