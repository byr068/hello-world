...
<body>
<form action="inspt_point/${msg }.do" id="Form"   method="post">
    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td style="width:100px;text-align: right;padding-top: 13px;">巡检点名称:</td>
                <td><input style="width:95%;" type="text" name="point_name" id="point_name" value="${pd.point_name}" maxlength="100" placeholder="这里输入巡检点名称" title=""/></td>
            </tr>
            <tr>
