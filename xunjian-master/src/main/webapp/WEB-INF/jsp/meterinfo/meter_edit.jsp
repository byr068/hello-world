...
<form action="meter/${msg}.do" id="Form"   method="post">
    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                <td style="width:100px;text-align: right;padding-top: 13px;">水表名称:</td>
            ...
            <tr>
                <td style="width:100px;text-align: right;padding-top: 13px;">水表位置:</td>
            ...
            <tr>
                <td style="width:100px;text-align: right;padding-top: 13px;">水表编号:</td>
