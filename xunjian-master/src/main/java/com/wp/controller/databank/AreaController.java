 ...
 */
@Controller
@RequestMapping(value="/inspt_area")
public class AreaController extends BaseController {

    String menuUrl = "inspt_area/list.do"; //菜单地址(权限用)
    ...
    public ModelAndView list(Page page){
        ...
        try{
            ...
            page.setPd(pd);
            List<PageData> varList = areaService.list(page);	//列出${objectName}列表
            mv.setViewName("databank/inspt_area");
    ...
    public ModelAndView goAdd(){
        ...
        pd = this.getPageData();
        try {
            mv.setViewName("databank/area_edit");
    ...
    public ModelAndView exportExcel(){
        ...
        try{
            ...
            for (int i = 0; i < varOList.size(); i++) {
                ...
                vpd.put("var3", varOList.get(i).getString("area_filed"));
                vpd.put("var4", varOList.get(i).getString("add_time"));
                varList.add(vpd);
            }
    ...
    public void downExcel(HttpServletResponse response)throws Exception{
        ...
        FileDownload.fileDownload(response, PathUtil.getClasspath() + Const.FILEPATHFILE + "inspt_area.xls", "inspt_area.xls");
    ...
    public ModelAndView readExcel(
        ...
        if (null != file && !file.isEmpty()) {
            ...
            String fileName =  FileUpload.fileUp(file, filePath, "inspt_areaexcel");							//执行上传
            ...
            for(PageData pds : listPd) {
                ...
                pd.put("area_filed", pds.getString("var2"));
                pd.put("create_time", pds.getString("var3"));
                areaService.save(pd);
            }
            mv.addObject("msg","success");
        }
