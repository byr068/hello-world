...
public class EventController extends BaseController{
        ...
        try{
            ...
            for (PageData p : varList) {
                ...
                if (StringUtils.isEmpty(qrcode)) {
                    ...
                    try {
                        String filePath = "D:/program file/apache-tomcat-7.0.91/webapps/qrupload/qrImg/" + encoderImgId;  //存放路径
            ...
            System.out.println(varList+"88888888888888888888888");
    ...
    public String addEvent1() throws Exception {
        ...
        if(StringUtils.isEmpty(pd.getString("workshop"))){
            ...
            System.out.println("---------------------------");
            System.out.println("车间id为："+workshopId);
            PageData workshop = new PageData();
